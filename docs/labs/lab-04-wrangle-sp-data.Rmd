...
<<<<<<< HEAD
This function is not available in R, but we have it saved in a file called `haversine.R` that we can load and then use it. Also, it's already available
in your R Markdown file.
=======
This function is not available in R, but we can define it ourselves by executing the following function definition:
>>>>>>> a6dd99dd6275993676bba31529d5a687d67cc098
...
(It would also be possible to have the above code saved by itself in a file called `haversine.R`, and we could simply run `source('haversine.R')`.)
...
8. Calculate the minimum distance between a Denny's and La Quinta for each Denny's 
...
7. Describe the distribution of the distances Denny's and the nearest La Quinta 
...
7. Describe the distribution of distances between Denny's and La Quinta 
   locations in Alaska. Also include an appropriate visualization and 
   relevant summary statistics.    
>>>>>>> a6dd99dd6275993676bba31529d5a687d67cc098
