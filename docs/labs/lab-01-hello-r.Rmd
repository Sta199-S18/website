...
<div style="position:relative;height:0;padding-bottom:3%"><iframe width="600" height="320" src="https://www.youtube.com/embed/q9rbok2GzhA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
...
<div style="position:relative;height:0;padding-bottom:3%"><iframe width="600" height="320"` src="https://www.youtube.com/embed/b_GvLvctSHQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
...
Before we introduce the data, let's warm up with some simple exercises. The following video is an overview of these warmup exercises.

<div style="position:relative;height:0;padding-bottom:3%"><iframe width="600" height="320" src="https://www.youtube.com/embed/PlhqUF7A6zk?ecver=2" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
...
Then, load the packages by running the following in the console as well. Note that the packages are also loaded in your R Markdown document.
...
2. **Change the look of your report:** 
