...
1. **Teams:** Find your teammates, introduce yourselves, and sit with them. Start thinking about a team name. Something memorable, funny ok, but keep it appropriate. You have until the end of class to select a name and let your TA know.
2. **Lab strucuture:** Lab structure overview.
3. **Lab 01:** Introduce the lab, and work through the first section as a class.
4. **On your own:** Work on the rest of the lab "on your own", but feel free to check in with teammates as much as you like.
...
## 3. Lab 01: Hello R! - Getting started
