...
2. Create one visualization based on the data you scraped

3. Examine each of the *first three* (or however many you can get through) movie subpage to also obtain
